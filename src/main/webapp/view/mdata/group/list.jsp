		...
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="ibox float-e-margins">
				...
				<div class="col-sm-12">
	                ...
	                <div class="col-sm-4">
	                	<input class="form-control" id="search" name="testName" value="${groupEntity.orgId }" type="text" placeholder="查询内容 回车搜索"/>
	                </div>
	                 <!-- ------------按钮组 end------------ -->
		                 ...
		                 <table class="table table-striped table-bordered table-hover table-condensed">
					        ...
					        <tbody>
					        	...
					        	<c:forEach var="e" items="${page.list }" varStatus="v">
						            <tr>
						                <td><input type="checkbox" name="ids" value="${e.orgId }"/></td>
						                <td>${e.orgName }</td>
						                <td>${e.orgNano }</td>
						                <td>${e.orgOpen }</td>
						                <td>${e.orgOrder }</td>
