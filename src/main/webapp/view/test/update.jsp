		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				<form action="${path }/test/update.do" method="post" class="form-horizontal" role="form">
					<input type="hidden" id="testId" name="testId" value="${testEntity.testId}"/>
                    <fieldset>
                        <legend>测试管理基本信息</legend>
                       <div class="form-group">
                          <label class="col-sm-2 control-label" for="ds_host">名称</label>
                          <div class="col-sm-4">
                             <input class="form-control" type="text" name="testName" placeholder="名称" value="${testEntity.testName}"/>
                          </div>
                          <label class="col-sm-2 control-label" for="ds_name">性别</label>
                          <div class="col-sm-4">
                             <zhg:select codeTp="sex" cls="form-control" name="testSex" def="true"  value="${testEntity.testSex}"></zhg:select>
                          </div>
                       </div>
                       <div class="form-group">
